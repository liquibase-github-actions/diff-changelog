...
USERNAME=${36}
# Global Options
ADDEMPTYMDCVALUES=${37}
ALLOWDUPLICATEDCHANGESETIDENTIFIERS=${38}
...
CLASSPATH=${45}
CONVERTDATATYPES=${46}
CUSTOMLOGDATAFILE=${47}
CUSTOMLOGDATAFREQUENCY=${48}
DATABASECHANGELOGLOCKTABLENAME=${49}
DATABASECHANGELOGTABLENAME=${50}
DATABASECLASS=${51}
DDLLOCKTIMEOUT=${52}
DEFAULTSFILE=${53}
DIFFCOLUMNORDER=${54}
...
SEARCHPATH=${97}
SECUREPARSING=${98}
SHOULDGENERATECHECKSRUNREPORT=${99}
SHOULDGENERATEROLLBACKREPORT=${100}
SHOULDRUN=${101}
